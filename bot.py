...
from config import API_ID, API_HASH, BOT_TOKEN, BOT_USERNAME, DB_CHANNEL, BOT_OWNER, DATABASE_URL,  UPDATES_CHANNEL, LOG_CHANNEL, BANNED_USERS, FORWARD_AS_COPY, BROADCAST_AS_COPY, BANNED_CHAT_IDS, OTHER_USERS_CAN_SAVE_FILE, API, URL, VERIFY_TUTORIAL, VERIFY, ABOUT_BOT_TEXT, ABOUT_DEV_TEXT, HOME_TEXT
...
from handlers.force_sub_handler import (
    handle_force_sub,get_invite_link
)
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("Bots Channel", url="https://t.me/alonekingjnanesh")
                    ],
                    [
